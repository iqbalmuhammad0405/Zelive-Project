    ...
    <ion-content class="register-bg" [fullscreen]="true">
      ...
      <div class="register-wrapper">
        ...
        <div class="header-section">
          ...
          <h1 class="page-title">Create <span>Seller</span> Account</h1>
          <p class="subtitle">Start broadcasting and selling products live</p>
        </div>
        ...
        <div class="glass-card register-card">
          <form (ngSubmit)="register()">
            <div class="input-container">
              ...
              <input type="text" [(ngModel)]="storeName" name="store_name" placeholder="Store Name" required class="custom-html-input">
            </div>
            ...
            <div class="input-container">
              ...
              <input type="text" [(ngModel)]="name" name="name" placeholder="Owner Full Name" required class="custom-html-input">
            </div>
            ...
            <div class="input-container">
              ...
              <input type="email" [(ngModel)]="email" name="email" placeholder="Business Email Address" required class="custom-html-input">
            </div>
            ...
            <div class="input-container">
              ...
              <input type="tel" [(ngModel)]="phone" name="phone" placeholder="Business Phone Number" class="custom-html-input">
            </div>
...
export class RegisterSellerComponent {
  ...
  async register() {
    if (!this.name || !this.email || !this.password || !this.phone || !this.storeName) {
    ...
    this.authService.register(regData).subscribe({
      next: (res: any) => {
        ...
        this.showToast('Seller registration successful!', 'success');
